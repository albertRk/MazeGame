...
class Game:
    ...
    def on_render(self):
        ...
        for k in range(0, 5):
            if self.not_to_draw[k] == False and self.player_x>=self.enems[k][0]-2 and self.player_x<=self.enems[k][0]+10 \
...
class Maze:
    ...
    def __init__(self):
        ...
        self.maze_width = 80
        self.maze_height = 60
        self.corners = [(1, self.maze_height-2), (self.maze_width-2, self.maze_height-2), (self.maze_width-2, 1)]
